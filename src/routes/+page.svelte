<script lang="ts">
  ...
  const works = [
    ...
    },
    {
      id: 'heroescape', 
      title: 'Hero Escape', 
      description: 'A 2D platformer about a hero surviving the dangerous lands outside the castle.',
...
<main class="min-h-screen bg-gradient-to-b from-zinc-900 to-black text-white font-sans selection:bg-white selection:text-black">
  <div class="max-w-2xl mx-auto px-6 py-24 flex flex-col gap-24">
    ...
    >
      ...
      <div class="flex flex-col items-center sm:items-start text-center sm:text-left pt-2">
        ...
        <a href="mailto:victoria.drewjason@gmail.com" class="flex items-center gap-2 hover:text-white/70 transition-colors border-b border-white/30 hover:border-white/70 pb-1">
        ...
        <a href="https://github.com/djvictoria" target="_blank" class="flex items-center gap-2 hover:text-white/70 transition-colors border-b border-white/30 hover:border-white/70 pb-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="https://www.linkedin.com/in/drew-jason-victoria-106429381" target="_blank" class="flex items-center gap-2 hover:text-white/70 transition-colors border-b border-white/30 hover:border-white/70 pb-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="https://beatbreadd.itch.io" target="_blank" class="flex items-center gap-2 hover:text-white/70 transition-colors border-b border-white/30 hover:border-white/70 pb-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none">
              <path d="M21.538 5.615c-1.346-.192-2.716-.36-4.086-.36-4.553 0-9.106 0-13.66.36-1.322.12-2.355 1.154-2.475 2.476L.3 14.46c-.12 1.25.65 2.404 1.875 2.62 1.226.216 2.476-.41 3.005-1.54l1.106-2.28c.24-.48.745-.793 1.274-.793h8.88c.53 0 1.034.313 1.274.793l1.106 2.28c.53 1.13 1.78 1.756 3.005 1.54 1.225-.216 1.995-1.37 1.875-2.62l-1.01-6.37c-.12-1.322-1.153-2.355-2.475-2.476zM7.34 8.717c.913 0 1.658.745 1.658 1.658s-.745 1.658-1.658 1.658-1.658-.745-1.658-1.658.745-1.658 1.658-1.658zm9.32 0c.913 0 1.658.745 1.658 1.658s-.745 1.658-1.658 1.658-1.658-.745-1.658-1.658.745-1.658 1.658-1.658z"/>
            </svg>
            Itch.io
        </a>
...
/* Background */
  ...
  main::before {
    ...
    /* Add this line below to turn the boxes into plus signs: */
